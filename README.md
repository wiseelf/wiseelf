...
**Software/DevOps Engineer** with over **10 years** of experience

*Technical geek with a passion for studying new technologies and devices.*  
*Love hiking, riding bikes, and having an active lifestyle.* 🚴‍♂️

📍 **Ukraine** 🇺🇦 / **Australia** 🇦🇺

☁️ AWS Community Builder

👥 [AWS Gold Coast User Group](https://kaidalov.com/aws-goldcoast-ug/) Co-organizer
...
On [kaidalov.com](https://kaidalov.com) I share practical insights from day-to-day work:

- **AWS** tips & best practices, cost optimization, security
- **Infrastructure as Code** – Terraform, automation, cloud management
